      ...
      <div className="h-[20%] flex flex-col items-center justify-center pt-1 relative">
        ...
        {uploader && (
          <div
            ...
            <BiCloudUpload size={20} /> <small className="font-semibold text-sm">Upload pdf</small>
          </div>
        )}
        <div className="w-[80%] shadow h-[40%] border border-gray-200 rounded-xl relative">
          <form className="block h-full px-16 py-2 relative">
            ...
            <button type="submit" className="p-3 text-slate-100 font-bold bg-green-600 rounded-md absolute top-1.5 right-3">
